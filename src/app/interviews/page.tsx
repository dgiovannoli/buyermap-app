...
interface InterviewLibraryProps {
  // Will be populated from localStorage or API in future
}

const mockInterviews: StoredInterview[] = [
  {
    id: '1',
    filename: 'Christina_Fouche_Interview.docx',
    ...
    quotesExtracted: 12,
    processingTime: 45,
    uniqueSpeakers: ['Christina Fouche'],
    vectorsStored: 87,
    tags: ['personal-injury', 'small-firm']
  },
  {
    id: '2', 
    filename: 'Cyrus_Nazarian_Interview.docx',
    ...
    quotesExtracted: 8,
    processingTime: 38,
    uniqueSpeakers: ['Cyrus Nazarian'],
    vectorsStored: 64,
    tags: ['mid-size-firm', 'corporate-law']
  },
  {
    id: '3',
    filename: 'Betty_Behrens_Interview.docx', 
    ...
    quotesExtracted: 15,
    processingTime: 52,
    uniqueSpeakers: ['Betty Behrens'],
    vectorsStored: 98,
    tags: ['large-firm', 'operations']
  }
];

export default function InterviewLibraryPage() {
  const [interviews, setInterviews] = useState<StoredInterview[]>(mockInterviews);
  const [filteredInterviews, setFilteredInterviews] = useState<StoredInterview[]>(mockInterviews);
  ...
  return (
    <div className="p-6">
      <div className="max-w-7xl mx-auto">
        {/* Header - Simplified since navigation now handles title */}
          ...
          <div className="bg-white overflow-hidden shadow rounded-lg">
            <div className="p-5">
              <div className="flex items-center">
                ...
                <div className="ml-5 w-0 flex-1">
                  <dl>
                    <dt className="text-sm font-medium text-gray-500 truncate">Industries</dt>
                    <dd className="text-lg font-medium text-gray-900">
                      {new Set(interviews.map(i => i.industry).filter(Boolean)).size}
                    </dd>
                  </dl>
                </div>
              </div>
            ...
            <div className="flex items-center space-x-4 mb-4">
              <div className="flex-1 relative">
                ...
                <input
                  ...
                  placeholder="Search interviews, roles, or tags..."
                  value={searchTerm}
              ...
              <div className="border-t pt-4 space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  ...
                  <div>
                    ...
                    <div className="space-y-2">
                      {['Legal Assistant', 'Associate Attorney', 'Legal Operations Manager', 'Partner'].map(role => (
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex items-center space-x-6 text-sm text-gray-500">
                          ...
                          <div className="flex items-center space-x-1">
                            ...
                            <span className="capitalize">{getCompanySizeIcon(interview.companySize)} {interview.companySize}</span>
                          </div>
